#' Generates bar chart for showing development in publication JIF mean
#'
...
mean_figure <- function(
    ...
    data <- readr::read_csv(
        here::here(historical_path, paste0("mean", historical_postfix, ".csv")),
